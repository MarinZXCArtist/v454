...
export default function PhotoSection({ photos, onAddPhoto, onDeletePhoto, onLikePhoto, isAdmin = false }: PhotoSectionProps) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {isAdmin ? (
          <div className="flex flex-wrap items-center gap-3">
            <span className="text-[11px] bg-rose-100 text-rose-600 font-extrabold px-3 py-1.5 rounded-full flex items-center gap-1 shadow-sm">
              <Sparkles size={12} className="animate-pulse text-rose-500 fill-rose-500" />
          ...
          <span className="text-xs text-rose-400/85 italic font-bold bg-rose-50/70 border border-rose-100/60 px-3 py-1.5 rounded-full shadow-sm flex items-center gap-1 self-start">
            <Heart size={11} className="fill-rose-400 text-rose-400 animate-pulse" />
            Режим просмотра воспоминаний 🌸
          </span>
        )}
      </div>
